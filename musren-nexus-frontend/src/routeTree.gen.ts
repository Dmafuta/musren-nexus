...
const AuthenticatedMerchantRewardConfigRoute =
  AuthenticatedMerchantRewardConfigRouteImport.update({
    id: '/merchant/reward-config',
    path: '/merchant/reward-config',
    getParentRoute: () => AuthenticatedRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/merchant/reward-config': {
      id: '/_authenticated/merchant/reward-config'
      path: '/merchant/reward-config'
      fullPath: '/merchant/reward-config'
      preLoaderRoute: typeof AuthenticatedMerchantRewardConfigRouteImport
      parentRoute: typeof AuthenticatedRoute
    }
    '/_authenticated/merchant/dashboard': {
